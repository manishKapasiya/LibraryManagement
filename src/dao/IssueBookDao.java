...
public class IssueBookDao {
    ...
    private static boolean isSameBookAlreadyIssued(Connection con,String bookcallno,int studentid){
        try {
            PreparedStatement ps = con.prepareStatement("select * from issuebooks where bookcallno=? and studentid=?");
            ps.setString(1, bookcallno);
    ...
    public static int save(String bookcallno,int studentid,String studentname,String studentcontact){
        ...
        try{
            ...
            if(!isSameBookAlreadyIssued(con,bookcallno,studentid)) {
